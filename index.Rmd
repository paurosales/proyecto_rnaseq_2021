...
Para análisis posteriores es necesario verificar si se forman clúster de expresión diferencial. A partir de **gráficas MDS** visualizamos la agrupación de muestras de acuerdo a alguno de los valores de las variables indicativas y sus niveles de expresión.

Las gráficas muestran poca definición de clústers, hay una ligera agrupación en la gráfica de Etapas FIGO (B), donde las muestras con Etapa FIGO I se concentran en el centro de la gráfica. Análisis posteriores nos permitirán determinar qué tan significativas son estas agrupaciones.
...
limma::plotMA(eb_results, coef = 4, main = "FIGO Stage II")
```
